...
async def create_channel(
    ...
    help="Use this command to create a new channel, admins only",
):
    guild = ctx.guild
...
@bot.command(
    name="roll",
    help="Simulates rolling dice, input # of dice and # of sides. In that order.",
)
...
class Music(commands.Cog):
    ...
    async def play(self, ctx, *, query):
        ...
        ctx.voice_client.play(
            source, after=lambda e: print(f"Player error: {e}s") if e else None
        )
